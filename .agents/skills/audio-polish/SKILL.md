...
bash .Codex/skills/audio-polish/scripts/polish.sh video-editor/outputs/<job>.mp4

# Explicit output path
bash .Codex/skills/audio-polish/scripts/polish.sh video-editor/outputs/<job>.mp4 /tmp/out.mp4

# Force a specific music file (overrides auto-detect)
bash .Codex/skills/audio-polish/scripts/polish.sh video-editor/outputs/<job>.mp4 --music ~/music/lofi.mp3

# Skip music bed even if one exists in inbox
bash .Codex/skills/audio-polish/scripts/polish.sh video-editor/outputs/<job>.mp4 --no-music
```
